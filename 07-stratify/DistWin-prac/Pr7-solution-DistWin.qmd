...
The whale density estimate from the unstratified analysis is around 25% larger than the corresponding estimates from *Full geog stratification* and *Pooled f(0)* above. The reason is that the survey design was geographically stratified, with less survey effort in the north stratum, and this is being ignored in the unstratified analysis.  
