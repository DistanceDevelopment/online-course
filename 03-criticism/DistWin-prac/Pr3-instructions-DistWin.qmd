...
# Mord detection function modelling and model criticism
...
1b) The full data set is in project `Exercise3-2023.zip` Download the file from [this link](Exercise3-2023.zip) and save the file in a location on your computer. Open `Distance for Windows`. Choose `Open project` and select zip file type to open the file and begin analysis.
