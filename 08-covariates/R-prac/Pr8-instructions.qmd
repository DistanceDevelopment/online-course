...
This exercise consists of three data sets of increasing difficulty. The first problem, MCDS with point transects, is complicated and (using the functionality available in `R`) also includes some basic exploratory analysis of the covariates. A [second data set](#more-mcds-with-line-transects-etp-dolphins) takes you deeper into the heart of understanding multiple covariates.
