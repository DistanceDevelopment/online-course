...
- Download and install the Distance software from http://distancesampling.org/Distance/distance75download.html, if you have not already. Once you have installed it, run `Distance`.
- Acquire the `Distance` project for this exercise
  - Click on [this link](Ducknest exercise.zip) to access data to be used in this exercise. You will be asked to save this file to your local computer. Remember the location where you saved the file, as you will be opening it in the next step.
