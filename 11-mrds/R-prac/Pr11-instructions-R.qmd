...
The third part of the practical involves analysis of the pack-ice seal survey data of [@Borchers2006] and [@Southwelll2007].  

To help understand the terminology used in MRDS and the output produced by `mrds`, there is a guide available ['Interpreting MRDS output'](Supplement-interpretingoutput.qmd). 
