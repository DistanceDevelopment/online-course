---
title: "Mark-Recapture Distance Sampling Exercises using Distance"
...
subtitle: Workshop on Distance sampling when animals are missed at zero distance
fontsize: 12pt
classoption: a4paper
---

This version of the practical is for those who would like to conduct the analysis in R using the package `mrds` (Laake et al. 2019).  There is a separate version for conducting the analysis in Distance for Windows.

The first part of this practical involves initial analysis of a survey of a known number of golf tees. This is intended mainly to familiarise you with the mrds function. We will do this during a short in-class break on the first day of class. 

The second part of the practical involves more detailed analysis of the golf tee data, and an exploration of the double-platform data structure.  We’ll do this after the first day of class and before the second.  

The third part of the practical involves analysis of the pack-ice seal survey data of Borchers et al. (2006) and Southwell et al. (2007).  We’ll do this after the first day of class and before the second.  

To help understand the terminology used in MRDS and the output produced by `mrds`, there is a guide available in the Teams file area 'Interpreting MRDS output'. 

# 1. Golf tee survey - initial analysis during class on Day 1
